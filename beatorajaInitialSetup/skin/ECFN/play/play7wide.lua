...
local function is_judgesize_default()
	return skin_config.option["判定文字サイズ"] == 932
end
local function is_judgesize_AC()
	return skin_config.option["判定文字サイズ"] == 933
end
...
local filepath = {
	{name = "Frame", path = "frame/wide/*.png"},
	{name = "Note", path = "notes/wide/*.png"},
...
local function main()
	...
	if is_judgesize_default() then
		geometry.judgesize_x = 7
		geometry.judgesize_y = 0
		geometry.judgesize_w = 0
		geometry.judgesize_h = 0
		geometry.judgesize_nx = 0
		geometry.judgesize_ny = 0
		geometry.judgesize_nw = 0
		geometry.judgesize_nh = 0
		geometry.judgesize_jdy = 0
	end
	--オプションの判定文字サイズがACの場合、以下のgeomety.judgesize_~~を元のgeometry.judge_~~に加算します
		if is_judgesize_AC() then
		geometry.judgesize_x = -24
		geometry.judgesize_y = 17
		geometry.judgesize_w = 50
		geometry.judgesize_h = 24
		geometry.judgesize_nx = 63
		geometry.judgesize_ny = 0
		geometry.judgesize_nw = 19
		geometry.judgesize_nh = 24
		geometry.judgesize_jdy = 41
	end
	...
	if is_left_side() then
		...
		geometry.turntable_x = 84
		geometry.fullcomboside_x = 0
		geometry.graphside_x = 78
		geometry.mainframe_x = 0
		geometry.mainframesrc_x = 497
		geometry.lanesrc_x = 0
		geometry.progress_x = 42
		geometry.lanes_x = 77
		geometry.lanes_w = 522
		geometry.lane_w_width = 61
		geometry.lane_b_width = 47
		geometry.lane_s_width = 106
		geometry.note_w_width = 61
		geometry.note_b_width = 47
		geometry.note_s_width = 106

		geometry.title_align = 0
		geometry.judge_x = 332
		geometry.judgedetail_x = 297
		geometry.judgedetail_y = 496

		geometry.diffscore_x = 612
		geometry.diffscore_y = 558

		geometry.judgecount_x = 476
		geometry.judgecount_y = 50

		geometry.keybeam_y = 357 - 62

		geometry.ready_x = 40
		geometry.title_x = 450
		geometry.gauge_x = 53
		geometry.gauge_w = 530
		geometry.gaugevalue_x = 414
		geometry.gaugeflash_x = 584

		geometry.song_title_w = 1000
		geometry.song_artist_w = 1000
		geometry.song_folde_w = 1000
	...
	if is_left_side() and is_score_graph_disabled() then

		geometry.timeleft = 621

		geometry.subframe_name = "sub_frame"
		geometry.subframe_x = 590-143

		geometry.minbpm_x = 1057 + 39
		geometry.nowbpm_x = 1165 + 39
		geometry.maxbpm_x = 1300 + 39

		geometry.stage_x = 1043 + 28

		geometry.song_title_x = 1230 + 28
		geometry.song_artist_x = 1230 + 28
		geometry.song_folde_x = 1230 + 28

		geometry.bga_x = 760
	end

	if is_left_side() and is_score_graph_enabled() then

		geometry.timeleft = 911

		geometry.subframe_name = "sub_frame"
		geometry.subframe_x = 590

		geometry.minbpm_x = 1057 + 182
		geometry.nowbpm_x = 1165 + 182
		geometry.maxbpm_x = 1300 + 182

		geometry.stage_x = 1043 + 171

		geometry.song_title_x = 1230 + 171
		geometry.song_artist_x = 1230 + 171
		geometry.song_folde_x = 1230 + 171
	...
	if is_right_side() then
		geometry.diffside_x = 1384
		geometry.diffsidesrc_x = 420
		geometry.keybeamside_x = 1145
		geometry.scbeamside_x = 1659
		geometry.keyfrashside_x = 1145

		geometry.scoreside_x = 1013
		geometry.hispeedside_x = 960
			
		geometry.turntable_x = 1796
		geometry.fullcomboside_x = 1254
		geometry.graphside_x = 498
		geometry.mainframe_x = 1303
		geometry.mainframesrc_x = 1114
		geometry.lanesrc_x = 522
		geometry.progress_x = 1854
		geometry.lanes_x = 1331
		geometry.lanes_w = 522
		geometry.lane_w_width = 61
		geometry.lane_b_width = 47
		geometry.lane_s_width = 106
		...
		geometry.title_align = 0
		geometry.judge_x = 251 + 1335
		geometry.judgedetail_x = 1556
		geometry.judgedetail_y = 496

		geometry.diffscore_x = 1226
		geometry.diffscore_y = 558
		...
		geometry.ready_x = 40
		geometry.title_x = 450
		geometry.gauge_x = 54+1363+451
		geometry.gauge_w = -530
		geometry.gaugevalue_x = 261+1076
		geometry.gaugeflash_x = 998 + 318
	...
	if is_right_side() and is_score_graph_disabled() then

		geometry.timeleft = 1017 + 203

		geometry.subframe_name = "sub_frame2"
		geometry.subframe_x = -408 + 132

		geometry.minbpm_x = 1032 + 132-817 + 132
		geometry.nowbpm_x = 1136 + 132-817 + 132
		geometry.maxbpm_x = 1275 + 132-817 + 132

		geometry.stage_x = 1043 + 132-817 - 40 + 132

		geometry.song_title_x = 1230 + 132 -817 - 40 + 132
		geometry.song_artist_x = 1230 + 132-817 - 40 + 132
		geometry.song_folde_x = 1230 + 132-817 - 40 + 132

		geometry.bga_x = 9  + 132
	end

	if is_right_side() and is_score_graph_enabled() then

		geometry.timeleft = 937

		geometry.subframe_name = "sub_frame2"
		geometry.subframe_x = -408

		geometry.minbpm_x = 1032 + 132-817
		geometry.nowbpm_x = 1136 + 132-817
		geometry.maxbpm_x = 1275 + 132-817

		geometry.stage_x = 1043 + 132-817 - 40

		geometry.song_title_x = 1230 + 132 -817 - 40
		geometry.song_artist_x = 1230 + 132-817 - 40
		geometry.song_folde_x = 1230 + 132-817 - 40
	...
	skin.source = {
		...
		{id = 14, path = "lane/wide/default.png"},
	...
	skin.image = {
		...
		{id = "background", src = "bg", x = geometry.mainframesrc_x, y = 2164, w = 617, h = 1080},
		{id = "groove_flash", src = "bg", x = 0, y = 3247, w = 20, h = 20},
		{id = "sub_frame", src = "bg", x = 715, y = 1082, w = 1740, h = 1080},
		{id = "sub_frame2", src = "bg", x = 715, y = 3275, w = 1740, h = 1080},
		...
		{id = "lane-bg", src = 14, x = geometry.lanesrc_x, y = 0, w = 522, h = 798},
		...
		{id = 12, src = 0, x = 0, y = 0, w = 431, h = 793},
		...
		{id = "note-b", src = 7, x = 277, y = 1, w = 47, h = 28},
		{id = "note-w", src = 7, x = 215, y = 1, w = 61, h = 28},
		{id = "note-s", src = 7, x = 108, y = 1, w = 106, h = 28},
		
		{id = "lns-b", src = 7, x = 277, y = 88, w = 47, h = 28},
		{id = "lns-w", src = 7, x = 215, y = 88, w = 61, h = 28},
		{id = "lns-s", src = 7, x = 108, y = 88, w = 106, h = 28},

		{id = "lne-b", src = 7, x = 277, y = 59, w = 47, h = 28},
		{id = "lne-w", src = 7, x = 215, y = 59, w = 61, h = 28},
		{id = "lne-s", src = 7, x = 108, y = 59, w = 106, h = 28},
		
		{id = "lnb-b", src = 7, x = 277, y = 118, w = 47, h = 2, divy = 2, cycle = 266},
		{id = "lnb-w", src = 7, x = 215, y = 118, w = 61, h = 2, divy = 2, cycle = 266},
		{id = "lnb-s", src = 7, x = 108, y = 118, w = 106, h = 2, divy = 2, cycle = 266},

		{id = "lna-b", src = 7, x = 277, y = 117, w = 47, h = 1},
		{id = "lna-w", src = 7, x = 215, y = 117, w = 61, h = 1},
		{id = "lna-s", src = 7, x = 108, y = 117, w = 106, h = 1},

		{id = "hcns-b", src = 7, x = 277, y = 150, w = 47, h = 28},
		{id = "hcns-w", src = 7, x = 215, y = 150, w = 61, h = 28},
		{id = "hcns-s", src = 7, x = 108, y = 150, w = 106, h = 28},

		{id = "hcne-b", src = 7, x = 277, y = 121, w = 47, h = 28},
		{id = "hcne-w", src = 7, x = 215, y = 121, w = 61, h = 28},
		{id = "hcne-s", src = 7, x = 108, y = 121, w = 106, h = 28},

		{id = "hcnb-b", src = 7, x = 277, y = 182, w = 47, h = 2, divy = 2, cycle = 266},
		{id = "hcnb-w", src = 7, x = 215, y = 182, w = 61, h = 2, divy = 2, cycle = 266},
		{id = "hcnb-s", src = 7, x = 108, y = 182, w = 106, h = 2, divy = 2, cycle = 266},

		{id = "hcna-b", src = 7, x = 277, y = 179, w = 47, h = 1},
		{id = "hcna-w", src = 7, x = 215, y = 179, w = 61, h = 1},
		{id = "hcna-s", src = 7, x = 108, y = 179, w = 106, h = 1},
		
		{id = "hcnd-b", src = 7, x = 277, y = 182, w = 47, h = 2, divy = 2, cycle = 266},
		{id = "hcnd-w", src = 7, x = 215, y = 182, w = 61, h = 2, divy = 2, cycle = 266},
		{id = "hcnd-s", src = 7, x = 108, y = 182, w = 106, h = 2, divy = 2, cycle = 266},

		{id = "hcnr-b", src = 7, x = 277, y = 180, w = 47, h = 2, divy = 2, cycle = 100},
		{id = "hcnr-w", src = 7, x = 215, y = 180, w = 61, h = 2, divy = 2, cycle = 100},
		{id = "hcnr-s", src = 7, x = 108, y = 180, w = 106, h = 2, divy = 2, cycle = 100},
	
		{id = "mine-b", src = 7, x = 277, y = 30, w = 47, h = 28},
		{id = "mine-w", src = 7, x = 215, y = 30, w = 61, h = 28},
		{id = "mine-s", src = 7, x = 108, y = 30, w = 106, h = 28},
	...
	skin.value = {
		...
		--コンボ数値
		--光らせる為に改変 要画像差し替え
		{id = "judgen-pg", src = 4, x = 232, y = 0, w = 560, h = 504, divx = 10, divy = 6, digit = 6, ref = 75, cycle = 100},
		{id = "judgen-gr", src = 4, x = 232, y = 505, w = 560, h = 84 * 2, divx = 10, divy = 2, digit = 6, ref = 75, cycle = 60},
		{id = "judgen-gd", src = 4, x = 232, y = 505, w = 560, h = 84 * 2, divx = 10, divy = 2, digit = 6, ref = 75, cycle = 60},
		{id = "judgen-bd", src = 4, x = 232, y = 505, w = 560, h = 84 * 2, divx = 10, divy = 2, digit = 6, ref = 75, cycle = 60},
		{id = "judgen-pr", src = 4, x = 232, y = 505, w = 560, h = 84 * 2, divx = 10, divy = 2, digit = 6, ref = 75, cycle = 60},
		{id = "judgen-ms", src = 4, x = 232, y = 505, w = 560, h = 84 * 2, divx = 10, divy = 2, digit = 6, ref = 75, cycle = 60},
		--FS判定用数値
	...
	skin.slider = {
		{id = "musicprogress", src = 18, x = 0, y = 0, w = 24, h = 36, angle = 2, range = 692 ,type = 6},
		{id = "musicprogress-fin", src = 18, x = 0, y = 0, w = 24, h = 36, angle = 2, range = 692 ,type = 6},
		{id = "lanecover", src = 12, x = 0, y = 0, w = 431, h = 723, angle = 2, range = 793,type = 4},
	}
	skin.hiddenCover = {
	...
	skin.note = {
		...
		group = {
			{id = "section-line", offset = 3, dst = {
				{x = geometry.lanes_x, y = 287, w = 512, h = 1, r = 128, g = 128, b = 128}
			}}
		},
		time = {
			{id = "section-line", offset = 3, dst = {
				{x = geometry.lanes_x, y = 287, w = 512, h = 1, r = 64, g = 192, b = 192}
			}}
		},
		bpm = {
			{id = "section-line", offset = 3, dst = {
				{x = geometry.lanes_x, y = 287, w = 512, h = 2, r = 0, g = 192, b = 0}
			}}
		},
		stop = {
			{id = "section-line", offset = 3, dst = {
				{x = geometry.lanes_x, y = 287, w = 512, h = 2, r = 192, g = 192, b = 0}
			}}
		}
	}
	skin.note.dst = {}
	...
	skin.judge = {
		{
			...
			index = 0,
			images = {
				{id = "judgef-pg", loop = -1, timer = 46, offsets = {3, 32}, filter = 1, dst = {
					{time = 0, x = geometry.judge_x -131 + geometry.judgesize_x, y = 400 - 18 + geometry.judgesize_y, w = 231 + geometry.judgesize_w, h = 84 + geometry.judgesize_h},
					{time = 500}
				}},
				{id = "judgef-gr", loop = -1, timer = 46, offsets = {3, 32}, filter = 1, dst = {
					{time = 0, x = geometry.judge_x -131 + geometry.judgesize_x, y = 400 - 18 + geometry.judgesize_y, w = 231 + geometry.judgesize_w, h = 84 + geometry.judgesize_h},
					{time = 500}
				}},
				{id = "judgef-gd", loop = -1, timer = 46, offsets = {3, 32}, filter = 1, dst = {
					{time = 0, x = geometry.judge_x -103 + geometry.judgesize_x, y = 400 - 18 + geometry.judgesize_y, w = 186 + geometry.judgesize_w, h = 84 + geometry.judgesize_h},
					{time = 500}
				}},
				{id = "judgef-bd", loop = -1, timer = 46, offsets = {3, 32}, filter = 1, dst = {
					{time = 0, x = geometry.judge_x -83 + geometry.judgesize_x, y = 400 - 18 + geometry.judgesize_y, w = 142 + geometry.judgesize_w, h = 84 + geometry.judgesize_h},
					{time = 500}
				}},
				{id = "judgef-pr", loop = -1, timer = 46, offsets = {3, 32}, filter = 1, dst = {
					{time = 0, x = geometry.judge_x -103 + geometry.judgesize_x, y = 400 - 18 + geometry.judgesize_y, w = 186 + geometry.judgesize_w, h = 84 + geometry.judgesize_h},
					{time = 500}
				}},
				{id = "judgef-ms", loop = -1, timer = 46, offsets = {3, 32}, filter = 1, dst = {
					{time = 0, x = geometry.judge_x -91 + geometry.judgesize_x, y = 400 - 18 + geometry.judgesize_y, w = 162 + geometry.judgesize_w, h = 84 + geometry.judgesize_h},
					{time = 500}
				}}
			},
			numbers = {
				{id = "judgen-pg", loop = -1, timer = 46, offsets = {32}, filter = 1, dst = {
					{time = 0, x = 242 + geometry.judgesize_nx, y = 0 + geometry.judgesize_ny, w = 56 + geometry.judgesize_nw, h = 84 + geometry.judgesize_nh},
					{time = 500}
				}},
				{id = "judgen-gr", loop = -1, timer = 46, offsets = {32}, filter = 1, dst = {
					{time = 0, x = 242 + geometry.judgesize_nx, y = 0 + geometry.judgesize_ny, w = 56 + geometry.judgesize_nw, h = 84 + geometry.judgesize_nh},
					{time = 500}
				}},
				{id = "judgen-gd", loop = -1, timer = 46, offsets = {32}, filter = 1, dst = {
					{time = 0, x = 242 + geometry.judgesize_nx, y = 0 + geometry.judgesize_ny, w = 56 + geometry.judgesize_nw, h = 84 + geometry.judgesize_nh},
					{time = 500}
				}},
				{id = "judgen-bd", loop = -1, timer = 46, offsets = {32}, filter = 1, dst = {
					{time = 0, x = 242 + geometry.judgesize_nx, y = 0 + geometry.judgesize_ny, w = 56 + geometry.judgesize_nw, h = 84 + geometry.judgesize_nh},
					{time = 500}
				}},
				{id = "judgen-pr", loop = -1, timer = 46, offsets = {32}, filter = 1, dst = {
					{time = 0, x = 242 + geometry.judgesize_nx, y = 0 + geometry.judgesize_ny, w = 56 + geometry.judgesize_nw, h = 84 + geometry.judgesize_nh},
					{time = 500}
				}},
				{id = "judgen-ms", loop = -1, timer = 46, offsets = {32}, filter = 1, dst = {
					{time = 0, x = 242 + geometry.judgesize_nx, y = 0 + geometry.judgesize_ny, w = 56 + geometry.judgesize_nw, h = 84 + geometry.judgesize_nh},
					{time = 500}
				}}
			},
...
--
	...
	skin.destination = {
		--{id = "sub_frame", dst = {
		{id = geometry.subframe_name, dst = {
			{x = geometry.subframe_x, y = 0, w = 1740, h = 1080}
		}},
...
--ジャッジカウント
		...
		{id = "judge-frame", op = {906},dst = {
			{x = 531 + geometry.graphside_x, y = 4, w = 284, h = 141}
		}},
		{id = "judge-main", op = {906},dst = {
			{x = 538 + geometry.graphside_x, y = 13, w = 257, h = 113}
		}},
		{id = "judge-count-pg",op = {906}, dst = {
			{x = 578 + geometry.graphside_x, y = 109, w = 16, h = 16}
		}},
		{id = "judge-count-gr",op = {906}, dst = {
			{x = 578 + geometry.graphside_x, y = 109 - 16 * 1, w = 16, h = 16}
		}},
		{id = "judge-count-gd",op = {906}, dst = {
			{x = 578 + geometry.graphside_x, y = 109 - 16 * 2, w = 16, h = 16}
		}},
		{id = "judge-count-bd",op = {906}, dst = {
			{x = 578 + geometry.graphside_x, y = 109 - 16 * 3, w = 16, h = 16}
		}},
		{id = "judge-count-pr",op = {906}, dst = {
			{x = 578 + geometry.graphside_x, y = 109 - 16 * 4, w = 16, h = 16}
		}},
		{id = "judge-count-fl",op = {906}, dst = {
			{x = 578 + geometry.graphside_x, y = 109 - 16 * 5, w = 16, h = 16}
		}},
		{id = "judge-count-cb",op = {906}, dst = {
			{x = 578 + geometry.graphside_x, y = 109 - 16 * 6, w = 16, h = 16}
		}},

		{id = "judge-count-remain",op = {906}, dst = {
			{x = 742 + geometry.graphside_x, y = 109 - 16 * 1, w = 16, h = 16}
		}},
		{id = "judge-count-notes",op = {906}, dst = {
			{x = 742 + geometry.graphside_x, y = 109 - 16 * 2, w = 16, h = 16 , a = 150}
		}},
		{id = "judge-count-fast",op = {906}, dst = {
			{x = 742 + geometry.graphside_x, y = 109 - 16 * 4, w = 16, h = 16}
		}},
		{id = "judge-count-slow",op = {906}, dst = {
			{x = 742 + geometry.graphside_x, y = 109 - 16 * 6, w = 16, h = 16}
		}},
		...
		return is_judge_count_enabled() and (pf_early == pf_late or pf_total == pf_early )
			...
			{time = 0,x = 646 + geometry.graphside_x, y = 109, w = 73, h = 16,a = 0},
			{time = 300,x = 646 + geometry.graphside_x, y = 109, w = 73, h = 16,a = 255},
		}},
		...
		return is_judge_count_enabled() and (pf_early == pf_late)
			...
			{x = 646 + geometry.graphside_x, y = 109 - 16 * 1, w = 73, h = 16,a = 0},
			{time = 300,x = 646 + geometry.graphside_x, y = 109- 16 * 1, w = 73, h = 16,a = 255},
		}},
		...
		return is_judge_count_enabled() and (pf_early == pf_late)
			...
			{x = 646 + geometry.graphside_x, y = 109 - 16 * 2, w = 73, h = 16,a = 0},
			{time = 300,x = 646 + geometry.graphside_x, y = 109- 16 * 2, w = 73, h = 16,a = 255},
		}},
		...
		return is_judge_count_enabled() and (pf_early == pf_late)
			...
			{x = 646 + geometry.graphside_x, y = 109 - 16 * 3, w = 73, h = 16,a = 0},
			{time = 300,x = 646 + geometry.graphside_x, y = 109- 16 * 3, w = 73, h = 16,a = 255},
		}},
		...
		return is_judge_count_enabled() and (pf_early == pf_late)
			...
			{x = 646 + geometry.graphside_x, y = 109 - 16 * 4, w = 73, h = 16,a = 0},
			{time = 300,x = 646 + geometry.graphside_x, y = 109- 16 * 4, w = 73, h = 16,a = 255},
		}},
		...
		return is_judge_count_enabled() and (pf_early == pf_late)
			...
			{x = 646 + geometry.graphside_x, y = 109 - 16 * 5, w = 73, h = 16,a = 0},
			{time = 300,x = 646 + geometry.graphside_x, y = 109- 16 * 5, w = 73, h = 16,a = 255},
		}},
...
--ジャッジカウントここまで
		...
		{id = "lane-bg", loop = 1000, dst = {
			{time = 0, x = geometry.lanes_x - 5, y = 282, w = 522, h = 798, a = 0},
			{time = 1000, h = 798, a = 255}
		}},
		{id = -110, loop = 1000, offset = 44, dst = {
			{time = 0, x = geometry.lanes_x, y = 287, w = 512, h = 793, a = 0},
			{time = 1000, h = 798, a = 0}
		}},

--リフト
		{id = "liftcover",filter = 1 , offset = 3 , dst = {
			{x = geometry.lanes_x, y = -506, w = 512 , h = 793}
		}},

		{id = "lift-value", offset = 3, op = {270},dst = {
			{time = 0, x = geometry.lanes_x + geometry.lanes_w / 3 - 24, y = 268, w = 16, h = 16}
		}},
		{id = "lanecover-green", offset = 3, op = {270},dst = {
			{time = 0, x = geometry.lanes_x + geometry.lanes_w * 2 / 3 - 48, y = 268, w = 16, h = 16}
		}},
		{id = "lanecover-duration", offset = 3, op = {270},dst = {
			{time = 0, x = geometry.lanes_x + geometry.lanes_w * 1 - 120, y = 268, w = 16, h = 16}
		}},
--リフト見えるの対策用カバー　今度いい感じのものを考える
		{id = "black", dst = {
			{x = geometry.lanes_x, y = 5, w = 521 , h = 282}
		}},


		{id = "background", dst = {
			{x = geometry.mainframe_x, y = 0, w = 617, h = 1080}
		}},


		{id = "groove_flash", loop = 600, dst = {
			{time = 400, x = geometry.gaugeflash_x, y = 142, w = 20, h = 20, a = 0},
			{time = 600, x = geometry.gaugeflash_x, y = 142, w = 20, h = 20, a = 50},
		}},
		...
		{id = "minbpm", op = {177} , dst = {
			{x = geometry.minbpm_x, y = 106-17, w = 30, h = 21}
		}},
		{id = "nowbpm", dst = {
			{x = geometry.nowbpm_x, y = 106-15, w = 39, h = 25}
		}},
		{id = "maxbpm", op = {177} , dst = {
			{x = geometry.maxbpm_x, y = 106-17, w = 30, h = 21}
		}},

	
		{id = "hispeed", dst = {
			{x = 359 + 52 + geometry.hispeedside_x, y = 87 - 17 , w = 26, h = 24}
		}},
		{id = "hispeed-d", dst = {
			{x = 421 + 52 + geometry.hispeedside_x, y = 87 - 17 , w = 26, h = 24}
		}},
		{id = "ex_score", dst = {
			{x = 325 + 52 + geometry.scoreside_x, y = 45 - 16 , w = 39, h = 25}
		}},
...
--キーフラッシュゾーン
		...
		{id = "keyflash-w", timer = 101 , blend = 2 , dst = {
			{x = 176 + geometry.keyfrashside_x, y = 207, w = 81, h = 73}
		}},
		{id = "keyflash-b", timer = 102 , blend = 2 ,  dst = {
			{x = 240 + geometry.keyfrashside_x, y = 204, w = 67, h = 86}
		}},
		{id = "keyflash-w", timer = 103 , blend = 2 ,  dst = {
			{x = 290 + geometry.keyfrashside_x, y = 207, w = 81, h = 73}
		}},
		{id = "keyflash-b", timer = 104 , blend = 2 ,  dst = {
			{x = 354 + geometry.keyfrashside_x, y = 204, w = 67, h = 86}
		}},
		{id = "keyflash-w", timer = 105 , blend = 2 ,  dst = {
			{x = 404 + geometry.keyfrashside_x, y = 207, w = 81, h = 73}
		}},
		{id = "keyflash-b", timer = 106 , blend = 2 ,  dst = {
			{x = 468 + geometry.keyfrashside_x, y = 204, w = 67, h = 86}
		}},
		{id = "keyflash-w", timer = 107 , blend = 2 ,  dst = {
			{x = 518 + geometry.keyfrashside_x, y = 207, w = 81, h = 73}
		}},

--難易度表記ゾーン

		{id = "diff_0",op = {150}, dst = {
			{x = 104 + 52 + geometry.diffside_x , y = 64 - 15 , w = 223, h = 52}
		}},
		...
		{id = "diffnum_1",op = {151}, dst = {
			{x = 263 + 52 + geometry.diffside_x , y = 80 - 15 , w = 19, h = 18}
		}},
		...
		{id = "jud_0",op = {184}, dst = {
			{x = 131 + 52 + geometry.diffside_x , y = 80 - 15 , w = 87, h = 7}
		}},
		{id = "jud_1",op = {183}, dst = {
			{x = 131 + 52 + geometry.diffside_x , y = 80 - 15 , w = 87, h = 7}
		}},
...
--難易度表記ゾーンここまで
		...
		{id = "turntable",filter = 1, offset = 1, dst = {
			{time = 0, x = geometry.turntable_x, y = 205, w = 40, h = 40},
		}},



		{id = "keybeam-s", loop= -1, timer = 100, offset = 3 ,op = {32}, dst = {
			{time = 0, x = 77 + geometry.scbeamside_x, y = geometry.keybeam_y, w = 106, h = 0},
			{time = 50, x = 77 + geometry.scbeamside_x, y = geometry.keybeam_y, w = 106, h = 793},
			{time = 83, x = 77 + geometry.scbeamside_x, y = geometry.keybeam_y, w = 106, h = 793},
			{time = 167, x = 130 + geometry.scbeamside_x, y = geometry.keybeam_y, w = 0, h = 793,a= 0},
		}},
		...
		{id = "keybeam-s", timer = 120,loop= -1, offset = 3 ,op = {33}, dst = {
			{time = 0, x = 77 + geometry.scbeamside_x, y = geometry.keybeam_y, w = 106, h = 793},
			{time = 83, x = 130 + geometry.scbeamside_x, y = geometry.keybeam_y, w = 0, h = 793,a = 0},
		}},

		{id = "keybeam-w", timer = 101 , offset = 3 , dst = {
			{time = 0, x = 186 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 61, h = 793},
		}},
		{id = "keybeam-w", timer = 121,loop= -1 , offset = 3 , dst = {
			{time = 0, x = 186 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 61, h = 793},
			{time = 83, x = 216 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 0, h = 793,a = 0},
		}},

		{id = "keybeam-b", timer = 102, offset = 3 , dst = {
			{time = 0, x = 250 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 47, h = 793},
		}},
		{id = "keybeam-b", timer = 122 , loop= -1, offset = 3 , dst = {
			{time = 0, x = 250 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 47, h = 793},
			{time = 83, x = 273 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 0, h = 793,a = 0},
		}},

		{id = "keybeam-w", timer = 103, offset = 3 , dst = {
			{time = 0, x = 300 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 61, h = 793},
		}},
		{id = "keybeam-w", timer = 123,loop= -1, offset = 3 , dst = {
			{time = 0, x = 300 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 61, h = 793},
			{time = 83, x = 330 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 0, h = 793,a = 0},
		}},
		{id = "keybeam-b", timer = 104, offset = 3 , dst = {
			{time = 0, x = 364 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 47, h = 793},
		}},
		{id = "keybeam-b", timer = 124,loop= -1, offset = 3 , dst = {
			{time = 0, x = 364 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 47, h = 793},
			{time = 83, x = 387 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 0, h = 793,a = 0},
		}},
		{id = "keybeam-w", timer = 105, offset = 3 , dst = {
			{time = 0, x = 414 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 61, h = 793},
		}},
		{id = "keybeam-w", timer = 125,loop= -1, offset = 3 , dst = {
			{time = 0, x = 414 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 61, h = 793},
			{time = 83, x = 444 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 0, h = 793,a = 0},
		}},
		{id = "keybeam-b", timer = 106, offset = 3 , dst = {
			{time = 0, x = 478 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 47, h = 793},
		}},
		{id = "keybeam-b", timer = 126,loop= -1, offset = 3 , dst = {
			{time = 0, x = 478 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 47, h = 793},
			{time = 83, x = 501 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 0, h = 793,a = 0},
		}},
		{id = "keybeam-w", timer = 107, offset = 3 , dst = {
			{time = 0, x = 528 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 61, h = 793},
		}},
		{id = "keybeam-w", timer = 127,loop= -1, offset = 3 , dst = {
			{time = 0, x = 528 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 61, h = 793},
			{time = 83, x = 558 + geometry.keybeamside_x, y = geometry.keybeam_y, w = 0, h = 793,a = 0},
		}},
		...
		{id = "glow_base", blend = 2, offset = 3 , dst = {
			{x = geometry.lanes_x, y = 295 , w = 512 , h = 59, a = 150}
		}},

		{id = "glow_base", blend = 2, offset = 3 , timer = 140 ,dst = {
			{time = 0 ,x = geometry.lanes_x, y = 295 , w = 512 , h = 59 , a = 255 },
			{time = 750 ,x = geometry.lanes_x, y = 295 , w = 512 , h = 59 , a = 0 },
			{time = 1000 ,x = geometry.lanes_x, y = 295 , w = 512 , h = 59 , a = 0 },
		}}

	}

	table.insert(skin.destination, {id = 15, offset = 3, dst = { {x = geometry.lanes_x, y = 287, w = 512, h = 8} }})
	...
	for i = 1, 8 do
		table.insert(skin.destination, {
			...
			offsets = {3, 41},
			dst = {
				{ time = 0, x = geometry.lanes_center_x[i] - 150, y = 212 - 62 , w = 300, h = 300 },
				{ time = 300 }
			}
		})
	end
	...
	append_all(skin.destination, {
		{id = "lanecover",filter = 1 , dst = {
			{x = geometry.lanes_x, y = 1080, w = 512 , h = 793}
		}},
	})	
	...
	append_all(skin.destination, {
		{id = "judge"},
		--判定fs
		{id = "judge-early", loop = -1, timer = 46, filter = 1, op = {911,1242},offsets = {3, 33}, dst = {
			{time = 0, x = geometry.judgedetail_x, y = geometry.judgedetail_y + geometry.judgesize_jdy, w = 74, h = 18},
			{time = 500}
		}},
		{id = "judge-late", loop = -1, timer = 46, filter = 1, op = {911,1243},offsets = {3, 33}, dst = {
			{time = 0, x = geometry.judgedetail_x, y = geometry.judgedetail_y + geometry.judgesize_jdy, w = 74, h = 18},
			{time = 500}
		}},
		--判定ms
		{id = "judgems-1pg", filter= 1 , loop = -1, timer = 46 ,op = {912,-241},offsets = {3, 33}, dst = {
			{time = 0, x = geometry.judgedetail_x, y = geometry.judgedetail_y + geometry.judgesize_jdy, w = 18, h = 18},
			{time = 500}
		}},
		--判定ms(どっちもA)
		...
		{id = "gauge",filter = 1, loop = 700 , dst = {
			{time = 500, x = geometry.gauge_x, y = 135, w = geometry.gauge_w, h = 33 , a = 0},
			{time = 700, x = geometry.gauge_x, y = 135, w = geometry.gauge_w, h = 33 , a = 255},
		}},
		{id = "gauge",filter = 1,blend = 2 ,loop = 700 , draw = function()
			local GAUGETYPE = main_state.gauge_type()
			return GAUGETYPE == 4 or GAUGETYPE == 5
 		end,  dst = { 
			{time = 700, x = geometry.gauge_x, y = 135, w = geometry.gauge_w, h = 33 , a = 0 },
			{time = 1200, a = 80 },
			{time = 1500, a = 0 },
		}},

		{id = "gaugevalue", dst = {
			{time = 0, x = geometry.gaugevalue_x, y = 172, w = 39, h = 28}
		}},
		{id = "gaugevalue-d", dst = {
			{time = 0, x = geometry.gaugevalue_x + 126, y = 171, w = 25, h = 20}
		}}
	})
	append_all(skin.destination, {
		...
		--KeepAspect
			...
			{time = 0, x = geometry.bga_x, y = geometry.bga_y, w = geometry.bga_w, h = geometry.bga_h, a = 60},		
		}},
		...
		{id = "bga", stretch = 3,op = {928,925}, dst = {
			{time = 0, x = geometry.bga_x, y = geometry.bga_y +276, w = geometry.bga_w, h = geometry.bga_h -276, a = 60},		
		}},
		{id = "bga",op = {928,925},dst = {
			{time = 0, x = geometry.bga_x, y = geometry.bga_y +276, w = geometry.bga_w, h = geometry.bga_h -276},		
		}},
		--Full
		...
		{id = "chroma_key",op = {925}, dst = {
			{x = geometry.bga_x, y = geometry.bga_y, w = geometry.bga_w, h = 276},
		}},
		--暗転時のクロマキー用フタ
		{id = "-110", timer = 2,op = {925}, dst = {
			{x = geometry.bga_x, y = geometry.bga_y, w = geometry.bga_w, h = 276, a = 255, acc = 2},
		}},
		{id = "-110", timer = 3,op = {925}, dst = {
			{x = geometry.bga_x, y = geometry.bga_y, w = geometry.bga_w, h = 276, a = 255, acc = 2},
		}},
...
--BGA内曲情報_読み込み
		...
		{id = -100, loop = 400 ,op = {80,194,927} ,filter = 1,blend = 1, dst = {
			{time = 0, x = geometry.bga_x, y = geometry.bga_y, w = geometry.bga_w, h = geometry.bga_h, a = 0},
			{time = 400 ,a = 80 },
		}},
		...
		{id = "song-title_big", loop = 400 ,op = {80,194}, dst = {
			{time = 0, x = geometry.song_title_x + 12, y = 588, w = 900, h = 60 , a = 0},
			{time = 400 ,a = 255 },
		}},
...
--BGA内曲情報_読み込み完了
		...
		{id = -100, loop = -1 , timer = 40,op = {194,927} ,filter = 1,blend = 1, dst = {
			{time = 0, x = geometry.bga_x, y = geometry.bga_y, w = geometry.bga_w, h = geometry.bga_h, a = 80},
			{time = 400 ,a = 0 },
		}},
		...
		{id = "song-title_big", loop = -1, timer = 40,op = {194}, dst = {
			{time = 0, x = geometry.song_title_x + 12, y = 588, w = 900, h = 60 , a = 255},
			{time = 400 ,a = 0 },
		}},
		...
		{id = "musicprogress", dst = {
			{x = geometry.progress_x, y = 1005, w = 24 , h = 36}
		}},

		{id = "musicprogress", blend = 2, timer = 140 ,dst = {
			{time = 0 ,x = geometry.progress_x, y = 1005 , w = 24 , h = 36 , a = 128 },
			{time = 750 ,x = geometry.progress_x, y = 1005 , w = 24 , h = 36 , a = 0 },
			{time = 1000 ,x = geometry.progress_x, y = 1005 , w = 24 , h = 36 , a = 0 },
		}},
	})
...
--ロードバー
		{id = "loading", loop = 600, op = {80}, dst = {
			{time = 500, x = geometry.lanes_x + 62 , y = 417, w = 379, h = 50, a = 0},
			{time = 600, x = geometry.lanes_x + 62 , y = 417, w = 379, h = 50, a = 255},
			{time = 1600, x = geometry.lanes_x + 62 , y = 417, w = 379, h = 50, a = 100},
			{time = 2600, x = geometry.lanes_x + 62 , y = 417, w = 379, h = 50, a = 255},
		}},
--準備完了
		{id = "ready", loop = -1, timer = 40, acc = 2 , dst = {
			{time = 0, x = geometry.lanes_x + 62 , y = 357, w = 379, h = 160, a = 0, acc = 2},
			{time = 250, x = geometry.lanes_x + 62 , y = 357, w = 379, h = 160, a = 255, acc = 2},
			{time = 750, a = 255, acc = 2},
			{time = 950, y = 357, a = 0, acc = 2},
			{time = 1000}
		}},
		{id = "ready", loop = -1, timer = 40, blend = 2 , dst = {
			{time = 0, x = geometry.lanes_x - 64 , y = 357, w = 579, h = 160, a = 155, acc = 2},
			{time = 250, x = geometry.lanes_x + 62 , y = 357, w = 379, h = 160, a = 0, acc = 2},
		}},
		{id = "ready", loop = -1, timer = 40, blend = 2 , dst = {
			{time = 250, x = geometry.lanes_x + 62 , y = 357, w = 379, h = 160, a = 155, acc = 2},
			{time = 650, a = 0, acc = 2},
		}},
--演奏終了_drawでフルコンの時のみ消すようにした
		{id = "finish", loop = -1, timer = 143, acc = 2 , draw = function()
			...
			{time = 500, x = geometry.lanes_x + 62 , y = 357, w = 379, h = 160, a = 0, acc = 2},
			{time = 750, x = geometry.lanes_x + 62 , y = 357, w = 379, h = 160, a = 255, acc = 2},
			{time = 1250, a = 255, acc = 2},
			{time = 1450, y = 357, a = 0, acc = 2},
			{time = 1500}
		}},
		{id = "finish", loop = -1, timer = 143, blend = 2 , draw = function()
			...
			{time = 500, x = geometry.lanes_x - 64 , y = 357, w = 579, h = 160, a = 155, acc = 2},
			{time = 750, x = geometry.lanes_x + 62 , y = 357, w = 379, h = 160, a = 0, acc = 2},
		}},
		{id = "finish", loop = -1, timer = 143, blend = 2 , draw = function()
			local CB = main_state.number(425)
			return CB > 0
		end,  dst = {
			{time = 750, x = geometry.lanes_x + 62 , y = 357, w = 379, h = 160, a = 155, acc = 2},
			{time = 1150, a = 0, acc = 2},
		}},
...
--フルコン
		{id = "FC-header1", loop = -1, timer = 48,filter = 1, dst = {
			{time = 516, x = -55 + geometry.fullcomboside_x, y = 674, w = 325, h = 69 , a = 0},
			{time = 683, x = 80 + geometry.fullcomboside_x, a = 255},
			{time = 850, x = 87 + geometry.fullcomboside_x, a = 255},
			{time = 1150, x = 102 + geometry.fullcomboside_x, a = 255},
			{time = 1683, x = 128 + geometry.fullcomboside_x, a = 255},
			{time = 1850, x = 389 + geometry.fullcomboside_x, a = 0},
		}},

		{id = "FC-header2", loop = -1, timer = 48,filter = 1, dst = {
			{time = 516, x = 314 + geometry.fullcomboside_x, y = 620, w = 411, h = 69 , a = 0},
			{time = 683, x = 179 + geometry.fullcomboside_x, a = 255},
			{time = 850, x = 171 + geometry.fullcomboside_x, a = 255},
			{time = 1150, x = 156 + geometry.fullcomboside_x, a = 255},
			{time = 1683, x = 131 + geometry.fullcomboside_x, a = 255},
			{time = 1850, x = -133 + geometry.fullcomboside_x, a = 0},
		}},
		...
		{id = "FC-main1", loop = -1, timer = 48,blend = 2, dst = {
			{time = 16, x = 77 + geometry.fullcomboside_x, y = 357, w = 512, h = 0, a = 255 },
			{time = 116, x = 77 + geometry.fullcomboside_x, y = 1118, w = 512, h = -793, a = 255 },
			{time = 583, x = 331 + geometry.fullcomboside_x, y = 1118, w = 4, h = -793, a = 255 },
			{time = 833, x = 331 + geometry.fullcomboside_x, y = 1118, w = 4, h = -793, a = 130 },
			{time = 1233, x = 331 + geometry.fullcomboside_x, y = 1118, w = 4, h = -793, a = 0 },
		}},
		{id = "FC-main2", loop = -1, timer = 48,blend = 2, dst = {
			{time = 16, x = 77 + geometry.fullcomboside_x, y = 1080, w = 512, h = -793, a = 0 },
			{time = 183, x = 77 + geometry.fullcomboside_x, y = 1080, w = 512, h = -793, a = 255 },
			{time = 333, x = 77 + geometry.fullcomboside_x, y = 1080, w = 512, h = -793, a = 255 },
			{time = 683, x = 77 + geometry.fullcomboside_x, y = 1080, w = 512, h = -793, a = 0 },
		}},
		...
		{id = "FC-main4", loop = -1, timer = 48,blend = 2, dst = {
			{time = 366, x = -72 + geometry.fullcomboside_x, y = 542, w = 793, h = 352, a = 30 },
			{time = 500, x = -72 + geometry.fullcomboside_x, y = 584, w = 793, h = 271, a = 255 },
			{time = 816, x = -72 + geometry.fullcomboside_x, y = 680, w = 793, h = 76, a = 100 },
			{time = 1050, x = -72 + geometry.fullcomboside_x, y = 680, w = 793, h = 76, a = 0 },
		}},

		{id = "FC-flash1", loop = -1, timer = 48,blend = 2, dst = {
			{time = 16, x = -262 + geometry.fullcomboside_x, y = -156, w = 1200, h = 1038, a = 255 },
			{time = 116, x = 38 + geometry.fullcomboside_x, y = 105, w = 600, h = 519, a = 255 },
			{time = 283, x = 38 + geometry.fullcomboside_x, y = 105, w = 600, h = 519, a = 0 },
			{time = 515, x = -112 + geometry.fullcomboside_x, y = -25, w = 900, h = 778, a = 0 },
			{time = 516, x = -112 + geometry.fullcomboside_x, y = -25, w = 900, h = 778, a = 255 },
			{time = 633, x = 38 + geometry.fullcomboside_x, y = 105, w = 600, h = 519, a = 255 },
			{time = 1016, x = 38 + geometry.fullcomboside_x, y = 105, w = 600, h = 519, a = 0 },
		}},
		{id = "FC-flash2", loop = -1, timer = 48,blend = 2, dst = {
			{time = 16, x = -112 + geometry.fullcomboside_x, y = -25, w = 778, h = 778, a = 0},
			{time = 116, x = -37 + geometry.fullcomboside_x, y = 47, w = 649, h = 649, a = 255 },
			{time = 283, x = 113 + geometry.fullcomboside_x, y = 173, w = 390, h = 390, a = 255 },
			{time = 283, x = 158 + geometry.fullcomboside_x, y = 240, w = 300, h = 260, a = 0 },
		}},
		{id = "FC-flash3", loop = -1, timer = 48,blend = 2, dst = {
			{time = 16, x = 92 + geometry.fullcomboside_x, y = 156, w = 480, h = 480, a = 255},
			{time = 183, x = -364 + geometry.fullcomboside_x, y = -303, w = 1395, h = 1395, a = 255 },
			{time = 350, x = -628 + geometry.fullcomboside_x, y = -564, w = 1920, h = 1920, a = 0 },
		}},

		{id = "FC-ring1", loop = -1, timer = 48,blend = 2, dst = {
			{time = 16, x = 188 + geometry.fullcomboside_x, y = 276, w = 278, h = 230, a = 255 },
			{time = 116, x = 65 + geometry.fullcomboside_x, y = 174, w = 525, h = 434, a = 255 },
			{time = 350, x = -197 + geometry.fullcomboside_x, y = -43, w = 1050, h = 867, a = 0 },
			{time = 1015, x = 44 + geometry.fullcomboside_x, y = 156, w = 552, h = 456, a = 0 },
			{time = 1016, x = 44 + geometry.fullcomboside_x, y = 156, w = 552, h = 456, a = 255 },
			{time = 1966, x = -197 + geometry.fullcomboside_x, y = -43, w = 1050, h = 867, a = 0 },
		}},
		{id = "FC-ring2", loop = -1, timer = 48,blend = 2, dst = {
			{time = 516, x = 223 + geometry.fullcomboside_x, y = 308, w = 210, h = 123, a = 255 },
			{time = 1016, x = -91 + geometry.fullcomboside_x, y = 122, w = 807, h = 474, a = 255 },
			{time = 1533, x = -251 + geometry.fullcomboside_x, y = 17, w = 1129, h = 663, a = 0 },
		}},
		{id = "FC-ring3", loop = -1, timer = 48,blend = 2, dst = {
			{time = 583, x = 263 + geometry.fullcomboside_x, y = 338, w = 135, h = 64, a = 255 },
			{time = 1083, x = -766 + geometry.fullcomboside_x, y = -267, w = 2168, h = 1047, a = 255 },
			{time = 1533, x = -874 + geometry.fullcomboside_x, y = -331, w = 2385, h = 1152, a = 0 },
		}},
