...
local function createNotesProperty(notesInfo, key)
    ...
    if key == 5 then
        notesProperty.note = {"note-w", "note-b", "note-w", "note-b", "note-w", "note-s"}
        notesProperty.lnend = {"lne-w", "lne-b", "lne-w", "lne-b", "lne-w", "lne-s"}
        notesProperty.lnstart = {"lns-w", "lns-b", "lns-w", "lns-b", "lns-w", "lns-s"}
        notesProperty.lnbody = {"lnb-w", "lnb-b", "lnb-w", "lnb-b", "lnb-w", "lnb-s"}
        notesProperty.lnactive = {"lna-w", "lna-b", "lna-w", "lna-b", "lna-w", "lna-s"}
        notesProperty.hcnend = {"hcne-w", "hcne-b", "hcne-w", "hcne-b", "hcne-w", "hcne-s"}
        notesProperty.hcnstart = {"hcns-w", "hcns-b", "hcns-w",  "hcns-b", "hcns-w", "hcns-s"}
        notesProperty.hcnbody = {"hcnb-w", "hcnb-b", "hcnb-w", "hcnb-b", "hcnb-w", "hcnb-s"}
        notesProperty.hcnactive = {"hcna-w", "hcna-b", "hcna-w", "hcna-b", "hcna-w", "hcna-s"}
        notesProperty.hcndamage = {"hcnd-w", "hcnd-b", "hcnd-w", "hcnd-b", "hcnd-w", "hcnd-s"}
        notesProperty.hcnreactive = {"hcnr-w", "hcnr-b", "hcnr-w", "hcnr-b", "hcnr-w", "hcnr-s"}
        notesProperty.mine = {"mine-w", "mine-b", "mine-w", "mine-b", "mine-w","mine-s"}
        notesProperty.dst = {
            -- 1鍵
            {x = BASE.playsidePositionX + BASE.NOTES.KEY_POSITION[1], y = BASE.NOTES_JUDGE_Y - 12, w = notesInfo.whiteWidth, h = BASE.LANE_LENGTH - 12},
            -- 2鍵
            {x = BASE.playsidePositionX + BASE.NOTES.KEY_POSITION[2], y = BASE.NOTES_JUDGE_Y - 12, w = notesInfo.blueWidth, h = BASE.LANE_LENGTH - 12},
            -- 3鍵
            {x = BASE.playsidePositionX + BASE.NOTES.KEY_POSITION[3], y = BASE.NOTES_JUDGE_Y - 12, w = notesInfo.whiteWidth, h = BASE.LANE_LENGTH - 12},
            -- 4鍵
            {x = BASE.playsidePositionX + BASE.NOTES.KEY_POSITION[4], y = BASE.NOTES_JUDGE_Y - 12, w = notesInfo.blueWidth, h = BASE.LANE_LENGTH - 12},
            -- 5鍵
            {x = BASE.playsidePositionX + BASE.NOTES.KEY_POSITION[5], y = BASE.NOTES_JUDGE_Y - 12, w = notesInfo.whiteWidth, h = BASE.LANE_LENGTH - 12},
            -- 皿
            {x = BASE.playsidePositionX + BASE.NOTES.KEY_POSITION[6], y = BASE.NOTES_JUDGE_Y - 12, w = notesInfo.scWidth, h = BASE.LANE_LENGTH - 12},
        }
    elseif key == 7 then
        notesProperty.note = {"note-w", "note-b", "note-w", "note-b", "note-w", "note-b", "note-w", "note-s"}
        notesProperty.lnend = {"lne-w", "lne-b", "lne-w", "lne-b", "lne-w", "lne-b", "lne-w", "lne-s"}
        notesProperty.lnstart = {"lns-w", "lns-b", "lns-w", "lns-b", "lns-w", "lns-b", "lns-w", "lns-s"}
        notesProperty.lnbody = {"lnb-w", "lnb-b", "lnb-w", "lnb-b", "lnb-w", "lnb-b", "lnb-w", "lnb-s"}
        notesProperty.lnactive = {"lna-w", "lna-b", "lna-w", "lna-b", "lna-w", "lna-b", "lna-w", "lna-s"}
        notesProperty.hcnend = {"hcne-w", "hcne-b", "hcne-w", "hcne-b", "hcne-w", "hcne-b", "hcne-w", "hcne-s"}
        notesProperty.hcnstart = {"hcns-w", "hcns-b", "hcns-w", "hcns-b", "hcns-w",  "hcns-b", "hcns-w", "hcns-s"}
        notesProperty.hcnbody = {"hcnb-w", "hcnb-b", "hcnb-w", "hcnb-b", "hcnb-w", "hcnb-b", "hcnb-w", "hcnb-s"}
        notesProperty.hcnactive = {"hcna-w", "hcna-b", "hcna-w", "hcna-b", "hcna-w", "hcna-b", "hcna-w", "hcna-s"}
        notesProperty.hcndamage = {"hcnd-w", "hcnd-b", "hcnd-w", "hcnd-b", "hcnd-w", "hcnd-b", "hcnd-w", "hcnd-s"}
        notesProperty.hcnreactive = {"hcnr-w", "hcnr-b", "hcnr-w", "hcnr-b", "hcnr-w", "hcnr-b", "hcnr-w", "hcnr-s"}
        notesProperty.mine = {"mine-w", "mine-b", "mine-w", "mine-b", "mine-w", "mine-b", "mine-w","mine-s"}
        notesProperty.dst = {
            -- 1鍵
            {x = BASE.playsidePositionX + BASE.NOTES.KEY_POSITION[1], y = BASE.NOTES_JUDGE_Y - 12, w = notesInfo.whiteWidth, h = BASE.LANE_LENGTH - 12},
            -- 2鍵
            ...
            {x = BASE.playsidePositionX + BASE.NOTES.KEY_POSITION[5], y = BASE.NOTES_JUDGE_Y - 12, w = notesInfo.whiteWidth, h = BASE.LANE_LENGTH - 12},
            -- 6鍵
            {x = BASE.playsidePositionX + BASE.NOTES.KEY_POSITION[6], y = BASE.NOTES_JUDGE_Y - 12, w = notesInfo.blueWidth, h = BASE.LANE_LENGTH - 12},
            -- 7鍵
            {x = BASE.playsidePositionX + BASE.NOTES.KEY_POSITION[7], y = BASE.NOTES_JUDGE_Y - 12, w = notesInfo.whiteWidth, h = BASE.LANE_LENGTH - 12},
            -- 皿
            {x = BASE.playsidePositionX + BASE.NOTES.KEY_POSITION[8], y = BASE.NOTES_JUDGE_Y - 12, w = notesInfo.scWidth, h = BASE.LANE_LENGTH - 12},
        }
    end
    ...
    parts.note = {
        ...
        group = {
            {id = "section-line", offset = MAIN.OFFSET.LIFT, dst = {
                {x = BASE.playsidePositionX + 3, y = BASE.NOTES_JUDGE_Y, w = 513, h = 3, a = notesInfo.barlineBright}
            }}
        },
        time = {
            {id = "section-line", offset = MAIN.OFFSET.LIFT, dst = {
                {x = BASE.playsidePositionX + 3, y = BASE.NOTES_JUDGE_Y, w = 513, h = 15, r = 100, g = 100, b = 255}
            }}
        },
        bpm = {
            {id = "section-line", offset = MAIN.OFFSET.LIFT, dst = {
                {x = BASE.playsidePositionX + 3, y = BASE.NOTES_JUDGE_Y, w = 513, h = 15, r = 100, g = 255, b = 100}
            }}
        },
        stop = {
            {id = "section-line", offset = MAIN.OFFSET.LIFT, dst = {
                {x = BASE.playsidePositionX + 3, y = BASE.NOTES_JUDGE_Y, w = 513, h = 15, r = 255, g = 100, b = 100}
            }}
        }
    }
