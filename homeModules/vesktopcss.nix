...
:root {
  /* ACCENT COLORS */
  --main-color: #BB77FF; /* main accent color (hex, rgb or hsl) [default: #2780e6] */
  ...
  --background-image: url(https://i.imgur.com/8hTGUaI.jpeg); /* app background image (link must be HTTPS) [default: url(https://clearvision.github.io/images/sapphire.jpg)]*/
